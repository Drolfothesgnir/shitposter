...
func CheckCloseTag(ctx *ActionContext) {
	...
	// relStartIdx is relative to the string input[contentStartIdx:scanEnd], therefore to make it absolute
	...
	ctx.Bounds.PayloadLimitReached = absStartIdx == -1 && scanEnd < n
